static const int RBM = 5, RBN = 6, RBK = 7;
static const int CBM = 35, CBN = 36, CBK = 35;
static inline void kloop(size_t p, t* a0, size_t lda, t* b0, size_t ldb, t* c, size_t ldc)
{
  ...
  for (t *a = a0, *b = b0; a < a0 + p/RBK*RBK; a += RBK, b += RBK*ldb)
  {
    ...
    c_3_5 = fma(a_3[0], b_0[5], c_3_5);
    c_4_0 = fma(a_4[0], b_0[0], c_4_0);
    c_4_1 = fma(a_4[0], b_0[1], c_4_1);
    c_4_2 = fma(a_4[0], b_0[2], c_4_2);
    c_4_3 = fma(a_4[0], b_0[3], c_4_3);
    c_4_4 = fma(a_4[0], b_0[4], c_4_4);
    c_4_5 = fma(a_4[0], b_0[5], c_4_5);
    ...
    c_3_5 = fma(a_3[1], b_1[5], c_3_5);
    c_4_0 = fma(a_4[1], b_1[0], c_4_0);
    c_4_1 = fma(a_4[1], b_1[1], c_4_1);
    c_4_2 = fma(a_4[1], b_1[2], c_4_2);
    c_4_3 = fma(a_4[1], b_1[3], c_4_3);
    c_4_4 = fma(a_4[1], b_1[4], c_4_4);
    c_4_5 = fma(a_4[1], b_1[5], c_4_5);
    ...
    c_3_5 = fma(a_3[2], b_2[5], c_3_5);
    c_4_0 = fma(a_4[2], b_2[0], c_4_0);
    c_4_1 = fma(a_4[2], b_2[1], c_4_1);
    c_4_2 = fma(a_4[2], b_2[2], c_4_2);
    c_4_3 = fma(a_4[2], b_2[3], c_4_3);
    c_4_4 = fma(a_4[2], b_2[4], c_4_4);
    c_4_5 = fma(a_4[2], b_2[5], c_4_5);
    ...
    c_3_5 = fma(a_3[3], b_3[5], c_3_5);
    c_4_0 = fma(a_4[3], b_3[0], c_4_0);
    c_4_1 = fma(a_4[3], b_3[1], c_4_1);
    c_4_2 = fma(a_4[3], b_3[2], c_4_2);
    c_4_3 = fma(a_4[3], b_3[3], c_4_3);
    c_4_4 = fma(a_4[3], b_3[4], c_4_4);
    c_4_5 = fma(a_4[3], b_3[5], c_4_5);
    ...
    c_3_5 = fma(a_3[4], b_4[5], c_3_5);
    c_4_0 = fma(a_4[4], b_4[0], c_4_0);
    c_4_1 = fma(a_4[4], b_4[1], c_4_1);
    c_4_2 = fma(a_4[4], b_4[2], c_4_2);
    c_4_3 = fma(a_4[4], b_4[3], c_4_3);
    c_4_4 = fma(a_4[4], b_4[4], c_4_4);
    c_4_5 = fma(a_4[4], b_4[5], c_4_5);
    ...
    c_3_5 = fma(a_3[5], b_5[5], c_3_5);
    c_4_0 = fma(a_4[5], b_5[0], c_4_0);
    c_4_1 = fma(a_4[5], b_5[1], c_4_1);
    c_4_2 = fma(a_4[5], b_5[2], c_4_2);
    c_4_3 = fma(a_4[5], b_5[3], c_4_3);
    c_4_4 = fma(a_4[5], b_5[4], c_4_4);
    c_4_5 = fma(a_4[5], b_5[5], c_4_5);
    c_0_0 = fma(a_0[6], b_6[0], c_0_0);
    c_0_1 = fma(a_0[6], b_6[1], c_0_1);
    c_0_2 = fma(a_0[6], b_6[2], c_0_2);
    c_0_3 = fma(a_0[6], b_6[3], c_0_3);
    c_0_4 = fma(a_0[6], b_6[4], c_0_4);
    c_0_5 = fma(a_0[6], b_6[5], c_0_5);
    c_1_0 = fma(a_1[6], b_6[0], c_1_0);
    c_1_1 = fma(a_1[6], b_6[1], c_1_1);
    c_1_2 = fma(a_1[6], b_6[2], c_1_2);
    c_1_3 = fma(a_1[6], b_6[3], c_1_3);
    c_1_4 = fma(a_1[6], b_6[4], c_1_4);
    c_1_5 = fma(a_1[6], b_6[5], c_1_5);
    c_2_0 = fma(a_2[6], b_6[0], c_2_0);
    c_2_1 = fma(a_2[6], b_6[1], c_2_1);
    c_2_2 = fma(a_2[6], b_6[2], c_2_2);
    c_2_3 = fma(a_2[6], b_6[3], c_2_3);
    c_2_4 = fma(a_2[6], b_6[4], c_2_4);
    c_2_5 = fma(a_2[6], b_6[5], c_2_5);
    c_3_0 = fma(a_3[6], b_6[0], c_3_0);
    c_3_1 = fma(a_3[6], b_6[1], c_3_1);
    c_3_2 = fma(a_3[6], b_6[2], c_3_2);
    c_3_3 = fma(a_3[6], b_6[3], c_3_3);
    c_3_4 = fma(a_3[6], b_6[4], c_3_4);
    c_3_5 = fma(a_3[6], b_6[5], c_3_5);
    c_4_0 = fma(a_4[6], b_6[0], c_4_0);
    c_4_1 = fma(a_4[6], b_6[1], c_4_1);
    c_4_2 = fma(a_4[6], b_6[2], c_4_2);
    c_4_3 = fma(a_4[6], b_6[3], c_4_3);
    c_4_4 = fma(a_4[6], b_6[4], c_4_4);
    c_4_5 = fma(a_4[6], b_6[5], c_4_5);
  }
